    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">               
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-file"></i> Добавить статью
                        </li>
                    </ol>                    
                </div>                 
            </div>
            ...
            <div class="col-lg-6 tab_margin_top">               
                <form action="add_article" method="POST" class="form-submit" enctype="multipart/form-data">
                    ...
                    <div class='tab_margin_top'>
                        <button class="btn btn-info" type='submit' name="add_post" value=""><i class="fa fa-save"></i> Сохранить</button>
