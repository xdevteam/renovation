                ...
                <div class="col-lg-12">
                    <h1 class="page-header">
                        ...
                        <div class="col-lg-3 col-sm-auto pull-right">
                            <a href="<?= base_url('admin'); ?>/news_article_add" class="btn btn-primary btn-labeled" style="width: 100%;">
                        ...
                        if (!empty($news)) {
                            foreach ($news as $item) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?=base_url('admin/news_article_edit/'.$item['id'])?>"><button class="btn btn-success" type='button'  value="<?= $item['id'] ?>"><i class="fa fa-pencil"></i> Редактировать</button></a></td>
                                    <td><button class="btn btn-danger"type='submit' name="delete_news[<?= $item['id'] ?>]" value="<?= $item['id'] ?>"><i class="fa fa-trash-o"></i> Удалить</button></td>
                                    <td><button class = "btn btn-default"type = 'submit' name = "status_news[<?= $item['id'] ?>]" value = "<?= $item['status'] ?>"><?= $btn_name ?></button></td>   
                                </tr>
                                <?php
                            }
                        }
