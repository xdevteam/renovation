<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <form action="<?= base_url('admin/del_hide_user_page') ?>" method="POST">
                    ...
                    if(!empty($pages)) {
                        foreach ($pages as $item) {
                            ...
                            <tr>
                                ...
                                <td><a href="<?=base_url('admin/page_edit/'.$item['link'])?>"><button class="btn btn-success" type='button' value="<?= $item['id'] ?>" <i class="fa fa-pencil"></i> Редактировать</button></a></td>
