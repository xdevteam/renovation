        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-6 tab_margin_top">               
                <form action="<?=base_url('admin/edit_article')?>" method="POST" class="form-submit" enctype="multipart/form-data">
                    ...
                    <!-- text Wysiwyg editor -->
                    <textarea  name="blog_page" id="editor1" cols="45" rows="5"><?= $post_edit[0]['blog_page'] ?></textarea>
                    <script type="text/javascript">
                        CKEDITOR.replace('editor1');
                    </script>
                    <!-- end text Wysiwyg editor -->
                    <div class='tab_margin_top'>
                        <button class="btn btn-info" type='submit' name="edit_article" value=""><i class="fa fa-save"></i> Сохранить</button>
